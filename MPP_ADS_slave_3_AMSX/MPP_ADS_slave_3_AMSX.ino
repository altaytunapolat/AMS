// ===== RS-485 SLAVE: ADS1115 (A0-A3 only), synced sampling + auto-reply slots =====
#include <Arduino.h>
#include <Wire.h>
#include <ADS1115_WE.h>

// -------------------- CONFIG --------------------
const uint8_t MY_ADDRESS = 2;         // <-- set 1 or 2 per slave
...
void setup() {
  ...
  if (!adc_ok) {
    ...
    // Continuous conversion of A0-A3, fastest conversion rate
